//g++ main.cpp src/Shapes.cpp src/KeyEvents.cpp -o BeachView -I./include -lfreeglut -lopengl32 -lglu32 -lwinmmS
#include <iostream>
#include <stdlib.h>
#include <math.h>
#include <GL/gl.h>
...
void drawScene()
{
    ...
    else if (KeyEvents::roomWindow == 'p')
    {
        ...
        else if (KeyEvents::skyColor == 'm')
        {
            ...
            // Body
            glBegin(GL_QUADS);
            glColor3ub(30, 144, 255); // Shirt color
            ...
            // Head
            glPushMatrix();
            glTranslatef(-0.55f, -0.35f, 0.0f);
            glColor3ub(253, 219, 148); // Skin color
            glutSolidSphere(0.05, 20, 20); // Head as a sphere
            glPopMatrix();

            // Eyes
            glPushMatrix();
            glTranslatef(-0.57f, -0.33f, 0.0f);
            ...
            // Legs
            glBegin(GL_QUADS);
            glColor3ub(0, 0, 255); // Pants color
            ...
            // Body
            glBegin(GL_QUADS);
            glColor3ub(255, 69, 0); // Shirt color
            glVertex2f(-0.50f, -0.6f);
            glVertex2f(-0.60f, -0.6f);
            glVertex2f(-0.60f, -0.4f);
            glVertex2f(-0.50f, -0.4f);
            ...
            // Legs
            glBegin(GL_QUADS);
            glColor3ub(0, 0, 139); // Pants color
            glVertex2f(-0.58f, -0.6f);
            glVertex2f(-0.56f, -0.7f);
            glVertex2f(-0.58f, -0.7f);
            glVertex2f(-0.56f, -0.6f);
...
int main(int argc, char **argv)
{
    ...
    sndPlaySound("Music\\background-music.wav", SND_ASYNC | SND_LOOP);
    glutMainLoop();
